...
``` {r, fig.height = 3, fig.width = 4}
TPregression <- lm(data = PeterPaul.chem.nutrients, tp_ug ~ depth + dissolvedOxygen) #response on left, explan of right
...
summary(TPmodel) #now we've explained 54% (rather than only 8% like before). But be careful bc this could lead to laziness which could lead to 
