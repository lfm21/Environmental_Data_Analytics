...
View(EPA.NCAir.O3.2017)
View(EPA.NCAir.O3.2018)
...
#tell R to look int hsi dataset, in this format, and change to Date
...
#4
EPA.NCAir.O3.2017.sitespecific <- select(EPA.NCAir.03.2017, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)

EPA.NCAir.O3.2018.sitespecific <- select(EPA.NCAir.03.2018, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)
...
#6 
#WARNING: I named the two ozone dataframes 03 (not O3; a zero not an O)
...
```{r}
library("knitr")
knit2pdf("MuzzyA04_DataWrangling_CORRECTED.Rmd")
```
